...
import { isUuid } from '../../../../core/utils/stringTools'
import { openGameCreationModalAction, closeGameCreationModalAction, setBetAction, createGame, hideGameCreationErrorMessage } from './GameCreationActions'
import CubesPicker from './CubesPicker/CubesPicker';
import PlayersPicker from './PlayersPicker/PlayersPicker';
...
function mapStateToProps(state) {
    ...
    const localCubeId = state.cubesPicker.selectedCubeId;
    const guest = state.playersPicker.selectedPlayerId;
